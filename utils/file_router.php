...
function file_router($dir_path, $only_index_files = true, $default_file = "404.php") {
    if (!empty($dir_path)) {
        ...
        $default_file = $dir_path . "/" . $default_file;
        ...
        if (!file_exists($file_path) && file_exists($default_file)) $file_path = $default_file;
